    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          Genova<h1 className="text-2xl font-bold text-white mb-2">C</h1>
          <p className="text-gray-400">Supercharge Your Career</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              {isLogin ? 'Sign in to continue your journey' : 'Join thousands of professionals'}
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            {isLogin && (
              <div className="flex justify-between items-center">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-purple-500 bg-transparent border-2 border-gray-400 rounded focus:ring-purple-500 focus:ring-2"
                  />
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-transparent flex items-center justify-center group"
            >
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-white/10 rounded-2xl bg-white/5 hover:bg-white/10 transition-all duration-300 group">
                ...
                <span className="ml-2 text-white text-sm">Continue with Google</span>
              </button>
            </div>
          </div>
